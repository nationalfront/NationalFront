document.addEventListener('DOMContentLoaded', () => {
    ...
    const namesList = [
        ...
        /* 43 */ "سرکار خانم مینو مرتضی لنگرودی",
    ...
    const flipDuration = parseFloat(getComputedStyle(document.documentElement).getPropertyValue('--flip-duration') || '0.8') * 1000;
    const unfoldDuration = parseFloat(getComputedStyle(document.documentElement).getPropertyValue('--unfold-duration') || '0.7') * 1000;
    ...
    function personalizeLetter() {
        ...
        if (!isNaN(personId) && personId >= 1 && personId <= namesList.length && backTextElement && frontUnfoldedElement) {
            ...
            console.log("No valid ID parameter found or elements missing. Using defaults.");
